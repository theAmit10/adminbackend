  ...
  try {
    ...
    for (const location of locations) {
      ...
      for (const time of times) {
        ...
        console.log(`Added LotDate for location ${location.lotlocation} at time ${time.lottime}`);
        ...
        console.log(`Added Playzone for location ${location.lotlocation} at time ${time.lottime} on date ${newLotDate.lotdate}`);
      }
    }
  } catch (error) {
