...
const rechargeModuleSchema = new mongoose.Schema({
  ...
  skrillList: [
    { type: mongoose.Schema.Types.ObjectId, ref: "SkrillPaymentType" },
  ],
  cryptoList: [
    { type: mongoose.Schema.Types.ObjectId, ref: "CryptoPaymentType" },
  ],
  paypalList: [
    { type: mongoose.Schema.Types.ObjectId, ref: "PaypalPaymentType" },
  ],
  otherList: [{ type: mongoose.Schema.Types.ObjectId, ref: "OtherPayment" }],
